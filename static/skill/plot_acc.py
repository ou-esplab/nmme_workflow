...
def _plot_panel_regional(ax, da: xr.DataArray, title: str, extent: list) -> object:
    """Draw one ACC panel on a PlateCarree regional map."""
    lon = da["lon"].values
...
def main() -> int:
    ...
    if args.region:
        ...
        outname = f"acc_{args.var}_{args.region}_init{args.init_month:02d}_{season_lbl}.png"
    else:
        plot_outdir = outdir
