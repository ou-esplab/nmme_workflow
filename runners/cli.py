...
def main() -> int:
    ...
    p.add_argument(
        ...
        help="Stages to run in order. Static one-time (no --init needed): climatology terciles skill. Main (require --init): ingest preprocess products pycpt publish ship-routing-products",
    )
    p.add_argument(
        "--climatology-root",
        type=str,
